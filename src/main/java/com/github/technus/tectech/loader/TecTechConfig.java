...
public class TecTechConfig extends ConfigManager {
  public TecTechConfig(File pConfigBaseDirectory,
  ...
  protected void Init() {
    ...
    ENABLE_TURRET_EXPLOSIONS = _mainConfig.getBoolean(
        "TurretBoomEnable", "features", ENABLE_TURRET_EXPLOSIONS,
        "Set to false to disable explosions caused by EM turrets");
    TURRET_DAMAGE_FACTOR = _mainConfig.getFloat(
        "TurretDamageFactor", "features", TURRET_DAMAGE_FACTOR, 0,
        Short.MAX_VALUE, "Damage is multiplied by this number");
    TURRET_EXPLOSION_FACTOR = _mainConfig.getFloat(
        "TurretExplosionFactor", "features", TURRET_EXPLOSION_FACTOR, 0,
        Short.MAX_VALUE, "Explosion strength is multiplied by this number");

    MOD_ADMIN_ERROR_LOGS = _mainConfig.getBoolean(
        "AdminErrorLog", "modules", MOD_ADMIN_ERROR_LOGS,
    ...
    TESLA_MULTI_GAS_OUTPUT = _mainConfig.getBoolean(
        "TeslaMultiGasOutput", "tesla_tweaks", TESLA_MULTI_GAS_OUTPUT,
    ...
    TESLA_MULTI_LOSS_FACTOR_OVERDRIVE = _mainConfig.getFloat(
        "TeslaMultiLossFactorOverdrive", "tesla_tweaks",
        TESLA_MULTI_LOSS_FACTOR_OVERDRIVE, 0, 1,
    ...
    TESLA_MULTI_LOSS_PER_BLOCK_T0 = _mainConfig.getInt(
        "TeslaMultiLossPerBlockT0", "tesla_tweaks",
        TESLA_MULTI_LOSS_PER_BLOCK_T0, 0, Integer.MAX_VALUE,
        "Tesla Tower power transmission loss per block per amp using no plasmas");
    TESLA_MULTI_LOSS_PER_BLOCK_T1 = _mainConfig.getInt(
        "TeslaMultiLossPerBlockT1", "tesla_tweaks",
        TESLA_MULTI_LOSS_PER_BLOCK_T1, 0, Integer.MAX_VALUE,
    ...
    TESLA_MULTI_LOSS_PER_BLOCK_T2 = _mainConfig.getInt(
        "TeslaMultiLossPerBlockT2", "tesla_tweaks",
        TESLA_MULTI_LOSS_PER_BLOCK_T2, 0, Integer.MAX_VALUE,
    ...
    TESLA_MULTI_PLASMA_PER_SECOND_T1_HELIUM = _mainConfig.getInt(
        "TeslaMultiPlasmaPerSecondT1Helium", "tesla_tweaks",
        TESLA_MULTI_PLASMA_PER_SECOND_T1_HELIUM, 0, Integer.MAX_VALUE,
    ...
    TESLA_MULTI_PLASMA_PER_SECOND_T1_NITROGEN = _mainConfig.getInt(
        "TeslaMultiPlasmaPerSecondT1Nitrogen", "tesla_tweaks",
        TESLA_MULTI_PLASMA_PER_SECOND_T1_NITROGEN, 0, Integer.MAX_VALUE,
    ...
    TESLA_MULTI_PLASMA_PER_SECOND_T2_RADON = _mainConfig.getInt(
        "TeslaMultiPlasmaPerSecondT2Radon", "tesla_tweaks",
        TESLA_MULTI_PLASMA_PER_SECOND_T2_RADON, 0, Integer.MAX_VALUE,
    ...
    TESLA_MULTI_RANGE_COEFFICIENT_PLASMA_T1 = _mainConfig.getInt(
        "TeslaMultiRangeCoefficientPlasmaT1", "tesla_tweaks",
        TESLA_MULTI_RANGE_COEFFICIENT_PLASMA_T1, 0, Integer.MAX_VALUE,
        "Tesla Tower T1 Plasmas Range Multiplier");
    TESLA_MULTI_RANGE_COEFFICIENT_PLASMA_T2 = _mainConfig.getInt(
        "TeslaMultiRangeCoefficientPlasmaT2", "tesla_tweaks",
        TESLA_MULTI_RANGE_COEFFICIENT_PLASMA_T2, 0, Integer.MAX_VALUE,
        "Tesla Tower T2 Plasmas Range Multiplier");
    TESLA_MULTI_RANGE_COVER = _mainConfig.getInt(
        "TeslaMultiRangeCover", "tesla_tweaks", TESLA_MULTI_RANGE_COVER, 0,
        Integer.MAX_VALUE,
        "Tesla Tower to Tesla Coil Rich Edition Cover max range");
    TESLA_MULTI_RANGE_TOWER = _mainConfig.getInt(
        "TeslaMultiRangeTower", "tesla_tweaks", TESLA_MULTI_RANGE_TOWER, 0,
        Integer.MAX_VALUE, "Tesla Tower to Tower max range");
    TESLA_MULTI_RANGE_TRANSCEIVER =
        _mainConfig.getInt("TeslaMultiRangeTransceiver", "tesla_tweaks",
                           TESLA_MULTI_RANGE_TRANSCEIVER, 0, Integer.MAX_VALUE,
                           "Tesla Tower to Transceiver max range");
    TESLA_SINGLE_LOSS_FACTOR_OVERDRIVE = _mainConfig.getFloat(
        "TeslaSingleLossFactorOverdrive", "tesla_tweaks",
        TESLA_SINGLE_LOSS_FACTOR_OVERDRIVE, 0, 1,
    ...
    TESLA_SINGLE_LOSS_PER_BLOCK = _mainConfig.getInt(
        "TeslaSingleLossPerBlock", "tesla_tweaks", TESLA_SINGLE_LOSS_PER_BLOCK,
        0, Integer.MAX_VALUE,
        "Tesla Transceiver power transmission loss per block per amp");
    TESLA_SINGLE_RANGE = _mainConfig.getInt(
        "TeslaSingleRange", "tesla_tweaks", TESLA_SINGLE_RANGE, 0,
        Integer.MAX_VALUE, "Tesla Transceiver to max range");
  }
